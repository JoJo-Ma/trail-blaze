...
export default function AdventurePage() {
    ...
    return (
        <div className="flex lg:flex-row flex-col">
            <div className="flex pt-20 px-10 lg:-ml-8 lg:w-full lg:grow xl:ml-0">
                <ComposableMap
                    projectionConfig={{
                        rotate: [-10, 0, 0],
                        scale: 147,
            ...
            <div className="px-6 lg:contents">
                <div className="mx-auto max-w-2xl pb-24 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-lg lg:flex-none lg:pt-32 xl:w-1/2">
